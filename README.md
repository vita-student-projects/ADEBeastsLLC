...
## Other Changes
We used a custom loss criterion to have the flexibility to weigh the different x, y, and heading differently. We chose to scale the heading loss by 4 times because the maximum value of the heading is less than the maximal displacements of the x and y positions. 
...
## Additional Notes
We attempted to train with a GRU, but were not able to get an ADE below ~2.5.
