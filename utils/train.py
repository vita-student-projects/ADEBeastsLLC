...
def train(model,
    ...
    earlystopping = EarlyStopping(patience=7, delta=0.002)
    ...
    for epoch in range(num_epochs):
        ...
        train_one_epoch(model,
                        ...
                        use_depth_aux,
                        use_semantic_aux)
        best_ADE, val_loss = validate(model, val_loader, device, logger, best_ADE, model_save_path, epoch)
